              ...
              children: [
                Container(
                  margin: EdgeInsets.symmetric(
                      vertical: heigth * 0.1, horizontal: width * 0.15),
                          ...
                          children: [
                            ...
                            ConstrainedBox(
                              constraints: BoxConstraints.expand(
                                  height: heigth * 0.05, width: width * 0.3),
                              child: Text(
                                weatherProvider
                    ...
                    child: ListView.builder(
                      itemBuilder: (context, index) {
                        return Container(
                          ...
                          children: [
                            Utils.iconWeather(
                                weatherProvider.prevCityWeatherModel[index].day
                                    .condition.code,
                                false),
                            SizedBox(
                              width: 6,
                            ...
                            Text(
                              Utils.diaSemana(weatherProvider
                                  .prevCityWeatherModel[index].date.weekday),
                            ...
                            ConstrainedBox(
                              constraints: BoxConstraints(
                                  minWidth: width * 0.2, maxWidth: width * 0.2),
                              child: Text(
                      ...
                      itemCount: weatherProvider.prevCityWeatherModel.length,
                  ...
                  child: ListView.builder(
                    itemBuilder: (BuildContext context, int index) {
                      return Column(children: [
                        ...
                        Utils.iconWeather(
                            weatherProvider.prevCityWeatherModel[0].hour[index]
                                .condition.code,
                            false),
                        SizedBox(
                          height: 12,
                    ...
                    itemCount:
                        weatherProvider.prevCityWeatherModel[0].hour.length,
                  ),
                )
              ],
            ),
